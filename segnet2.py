...
f1 = 'D:/building/big data/random_new_rotate_train'
f2 = 'D:/building/big data/random_new_rotate_train_label'
f3 = 'D:/building/big data/random_new_rotate_test'
f4 = 'D:/building/big data/random_new_rotate_test_label'
...
def train_model():
    ...
    autoencoder.save('segnet2_outputgray_v2.h5')
...
plt.title('Segnet_outputgray_model_v2 accuracy')
plt.ylabel('error')
plt.xlabel('epoch')
...
plt.title('Segnet_outputgray_v2 loss')
plt.ylabel('Loss')
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.show()
