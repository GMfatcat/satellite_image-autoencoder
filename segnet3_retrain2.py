# -*- coding: utf-8 -*-
"""
Created on Tue Nov  3 17:53:22 2020
...
f1 = 'D:/building/big data/retrain3'
f2 = 'D:/building/big data/retrain3_label'
...
def retrain_model():
    global history
    autoencoder2 = load_model('segnet3_retrain1.h5')
    ...
    autoencoder2.save('segnet3_retrain2.h5')
...
plt.title('Segnet3_retrain2 accuracy')
plt.ylabel('error')
plt.xlabel('epoch')
...
plt.title('Segnet3_retrain2 loss')
plt.ylabel('Loss')
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.show()
